export const RESUME_DATA: any = {
  ...
  personalWebsiteUrl: 'https://somasundar-dev.github.io',
  ...
  experiences: [
    ...
    },
    {
      ...
      summary:
        'Led a team of developers to design and implement scalable web applications using .NET Core, React, and Azure services. Focused on delivering high-quality software solutions that meet product requirements.',
      techStack: [
        '.NET',
        'C#',
        'React',
      ...
      logo: '',
      responsibilities: [
        'Gather analyze and document business requirements, functional requirements and data specifications to guide and develop various modules in the application.',
        'Responsible for mentoring and guiding the team members in the project.',
        'Added the feature to dynamically create complex calculation systems in the application.',
        'Understand the requirements of product and develop functional applications.',
        'Participated in Docker and Kubernetes deployment process in Azure Kubernetes Cluster.',
        'Implementation of data synchronization of windows-based application and web application',
        'Implementation of Electron.NET in application to Convert web application to offline application',
        'Worked with nginx, IIS and Azure during deployment process.',
        'Implemented Ocelot API Gateway to streamline request routing, enhance security, and optimize system performance within project architecture.',
        'Implemented CQRS (Command Query Responsibility Segregation) in application to maximize its performance, scalability and security.',
        'Prepare Unit test plan and support it with Unit test cases',
      ],
    },
    {
      ...
      logo: '',
      responsibilities: [
        'Understand the requirements of clients and develop functional .NET MVC applications.',
        'Provide technical solution to the issues faced by the site users.',
        'Integration of payment gateways like Paytm and 2C2P in .NET MVC applications.',
        'Responsible for packaging and deployments in staging applications.',
        'Prepare Unit test plan and support it with Unit test cases',
        'Fixing bugs and creating documents for enhancements.',
      ],
    },
  ],
  education: [
